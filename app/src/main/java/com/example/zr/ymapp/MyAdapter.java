...
public class MyAdapter extends SimpleAdapter implements Filterable{
	private int[] mTo;  
	...
	//public MyAdapter(Context context, List<Map<String, ?>> data, int resource, String[] from, int[] to) {
